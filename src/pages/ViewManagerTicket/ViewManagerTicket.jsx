    ...
    const fetchTicket = async () => {
      try {
        ...
        const response = await fetch(
          `${API_BASE_URL}/api/manager/ticket/${ticketId}`,
          {
            headers: {
              Authorization: token,
            },
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-3">
                  <label className="line-label">Ticket ID <em>*</em></label>
                  <input
                ...
                <div className="col-md-3">
                  ...
                  <select
                    name="priority"
                    className="form-control line-field form-select"
                    value={ticket?.priority || ""} disabled
                  >
                    <option value="">--Select--</option>
...
export default ViewManagerTicket;
