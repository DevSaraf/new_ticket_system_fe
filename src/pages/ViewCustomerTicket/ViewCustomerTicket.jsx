    ...
    const fetchTicket = async () => {
      try {
        ...
        const response = await fetch(
          `${API_BASE_URL}/api/customer/view-ticket/${ticketId}`,
          {
            headers: {
              Authorization: token,
            },
  ...
  return (
    <div className="container-fluid">
      <div className="d-sm-flex align-items-center mb-4">
        <h1 className="h4 mb-0 text-gray-800">View Customer Ticket</h1>
      </div>
      <div id="accordion">
...
export default ViewCustomerTicket;
